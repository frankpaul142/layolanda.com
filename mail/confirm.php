            <tr>
                <td bgcolor="#ffffff">
                    <img src="http://layolanda.com/web/images/portada-01.png" width="600" height="300" alt="alt_text" border="0" align="center" class="fluid" style="width: 100%; max-width: 600px; height: auto; background: #dddddd; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #ffffff;">
                </td>
            </tr>
            ...
            <tr>
                <td bgcolor="#ffffff" style="padding: 40px; text-align: center; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                    Hola <?=$model->names ?> por favor confirma tu cuenta dando click en el botón.
                    <br><br>
                    <!-- Button : Begin -->
            ...
            <tr>
                ...
                <td background="white" bgcolor="#ffffff" valign="middle" style="text-align: center; background-position: center center !important; background-size: cover !important;">
